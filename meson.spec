...
Source0  : https://github.com/mesonbuild/meson/releases/download/0.63.2/meson-0.63.2.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/0.63.2/meson-0.63.2.tar.gz.asc
...
%prep
%setup -q -n meson-0.63.2
cd %{_builddir}/meson-0.63.2
%patch1 -p1
pushd ..
cp -a meson-0.63.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662309642
