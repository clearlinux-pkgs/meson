...
Source0  : https://github.com/mesonbuild/meson/releases/download/1.6.1/meson-1.6.1.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/1.6.1/meson-1.6.1.tar.gz.asc
...
%setup -q -n meson-1.6.1
cd %{_builddir}/meson-1.6.1
%patch -P 1 -p1
pushd ..
cp -a meson-1.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735087492
