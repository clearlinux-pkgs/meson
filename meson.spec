...
Source0  : https://github.com/mesonbuild/meson/releases/download/0.60.1/meson-0.60.1.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/0.60.1/meson-0.60.1.tar.gz.asc
...
%prep
%setup -q -n meson-0.60.1
cd %{_builddir}/meson-0.60.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635953142
...
cp %{_builddir}/meson-0.60.1/COPYING %{buildroot}/usr/share/package-licenses/meson/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/meson-0.60.1/packaging/License.rtf %{buildroot}/usr/share/package-licenses/meson/00dcd169768382e0b6a13d0d110266754fedb62b
cp %{_builddir}/meson-0.60.1/packaging/macpages/English.lproj/license.html %{buildroot}/usr/share/package-licenses/meson/ed59b8ab4e260b632c935598bf0d1472e4e2dbdf
