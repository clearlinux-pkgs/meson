...
Source0  : https://github.com/mesonbuild/meson/releases/download/1.2.3/meson-1.2.3.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/1.2.3/meson-1.2.3.tar.gz.asc
...
%prep
%setup -q -n meson-1.2.3
cd %{_builddir}/meson-1.2.3
%patch -P 1 -p1
pushd ..
cp -a meson-1.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698017027
