...
#
# Source0 file verified with key 0xCEB167EFB5722BD6 (eschwartz93@gmail.com)
#
Name     : meson
Version  : 1.7.2
Release  : 143
URL      : https://github.com/mesonbuild/meson/releases/download/1.7.2/meson-1.7.2.tar.gz
Source0  : https://github.com/mesonbuild/meson/releases/download/1.7.2/meson-1.7.2.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/1.7.2/meson-1.7.2.tar.gz.asc
Source2  : CEB167EFB5722BD6.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) CEB167EFB5722BD6' gpg.status
%setup -q -n meson-1.7.2
cd %{_builddir}/meson-1.7.2
%patch -P 1 -p1
pushd ..
cp -a meson-1.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743805495
